...
class QuestionManager
{
    ...
    public function Question($answers)
    {
        ...
        foreach ($answers as $number => $answer) {
			if ($answer == $this->answers[$number]) {
				echo $y . "." . '<span style="color:white" >   ()</span>'. $answer . '<span style="color:blue" >   (correct)</span>' . "<br>";
                $y++;
            } else {
				echo $y . ". " .'<span style="color:white" >   ()</span>' . $answer . '<span style="color:red" > (incorrect)</span>'. "<br>";
                $y++;
            }
        }
    }
